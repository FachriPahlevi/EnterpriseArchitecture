...
class ComponentsController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $artefacts = Artefact::all(); // Retrieving artefacts data

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'artefacts'));
    }
