...
<body>
    <div style="display: flex; column; justify-content: center; padding: 24px;">    
        <div class="card" style="width: 24rem; height: 8rem; margin: 0 16px; border-radius: 10px;">
            <div class="card-body">
                <h4 class="card-title">Portofolio</h4>
                <p class="card-text">{{ $totalPortofolio }}</p>
            </div>
        </div>
        ...
        <div class="card" style="width: 24rem; height: 8rem; margin: 0 16px; border-radius: 10px;">
            <div class="card-body">
                <h5 class="card-title">Status Portofolio ON</h5>
                <p class="card-text"> {{ $chartData[0]['y'] ?? 0 }}</p>
            </div>
        </div>
    </div>

    <div style="display: flex; justify-content: center;">
        <div id="container" style="width: 60%; height: 400px; background-color: #f2f2f2; padding: 20px; border-radius: 10px;">
